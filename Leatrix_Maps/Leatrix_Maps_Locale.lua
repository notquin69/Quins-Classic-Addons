...
L["Show flight points"] = "Показывать точки полетов"
...
L["Your UI needs to be reloaded."] = "Необходимо перезагрузить интерфейс /reload"
...
L["Icons"] = "아이콘"
L["If checked, coordinates will be shown."] = "맵에 좌표가 표시됩니다."
L["If checked, dungeon and raid locations will be shown."] = "맵에 던전,공격대 위치가 표시 됩니다."
L["If checked, flight points will be shown."] = "비행지점이 표시 됩니다."
...
L["If checked, zone and dungeon levels will be shown."] = "지역과 던전레벨이 표시 됩니다."
