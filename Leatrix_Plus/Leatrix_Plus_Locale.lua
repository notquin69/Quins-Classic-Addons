...
L["If checked, helm and cloak toggle checkboxes will be shown in the character sheet."] = "Если стоит галочка, то появится кнопка в меню персонажа, которая показывает/скрывает плащ и шлем."
...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = [=[Если стоит галочка, то вы сможете изменить положение и масштаб следующих кадров:|n|n
- Фрейм игрока|n- Фрейм цели|n- Фрейм с бафами|n- Фрейм с виджетом|n- Таймер]=]
...
L["Show vendor price"] = "Показать цену у торговца"
...
L["If checked, helm and cloak toggle checkboxes will be shown in the character sheet."] = "투구와 망토의 표시/숨기기 체크 박스가 캐릭터 정보에 표시됩니다."
