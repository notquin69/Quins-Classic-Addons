...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword.|n|nYou need to be either not in a group or party leader in your own group for this to work."] = "勾選後，密語你關鍵字的任何人都會被寄送隊伍邀請。|n|n你需要在你自己的隊伍中，就算不是隊長也需要是隊員才能生效。"
...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword.|n|nYou need to be either not in a group or party leader in your own group for this to work."] = "그룹 초대는 설정된 키워드로 사람들에게 귓속말을 보낼 것입니다. 이 기능을 사용하려면 자신의 공격대 또는 파티 장이 아니어야합니다."
