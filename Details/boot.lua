...
--> global name declaration
		...
		--remove the underscope from global namespace
		_ = nil
		_detalhes = LibStub("AceAddon-3.0"):NewAddon("_detalhes", "AceTimer-3.0", "AceComm-3.0", "AceSerializer-3.0", "NickTag-1.0")
		
		_detalhes.build_counter = 168
		_detalhes.alpha_build_counter = 168 --if this is higher than the regular counter, use it instead
