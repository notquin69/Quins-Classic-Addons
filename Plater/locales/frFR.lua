...
L["OPTIONS_GENERALSETTINGS_HEALTHBAR_BGTEXTURE"] = "Texture de fond de barre de santé"
L["OPTIONS_GENERALSETTINGS_HEALTHBAR_TEXTURE"] = "Texture de barre de santé"
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_ANCHOR_TITLE"] = "Contrôle de la transparence"
...
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_RANGECHECK_ENABLED"] = "Utiliser une vérification de la distance"
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_RANGECHECK_ENABLED_DESC"] = [=[Les unités qui sont hors de portée ont leurs barres d'info plus transparentes.

|cFFFFFF00Important|r: vérifiez le sort que vous voulez utiliser pour vérifier la distance.]=]
...
L["OPTIONS_PLEASEWAIT"] = "Cela peut ne prendre que quelques secondes"
...
L["OPTIONS_PROFILE_CONFIG_PROFILENAME_DESC"] = [=[Un nouveau profil est créé avec la chaîne importée.

L'insertion du nom d'un profil déjà existant le remplacera.]=]
...
L["OPTIONS_PROFILE_ERROR_WRONGTAB"] = [=[Fichier de profil non valide.
...
L["OPTIONS_TABNAME_NPCFRIENDLY"] = "Npc Amical"
...
L["OPTIONS_TABNAME_THREAT"] = "Couleurs d'Aggro"
L["OPTIONS_TEXTURE"] = "Texture"
L["OPTIONS_THREAT_AGGROSTATE_ANOTHERTANK"] = "Aggro sur un autre Tank"
L["OPTIONS_THREAT_AGGROSTATE_HIGHTHREAT"] = "Haute menace"
L["OPTIONS_THREAT_AGGROSTATE_NOAGGRO"] = "Pas d'aggro"
L["OPTIONS_THREAT_AGGROSTATE_NOTANK"] = "Pas d'Aggro de Tank"
L["OPTIONS_THREAT_AGGROSTATE_NOTINCOMBAT"] = "Unité pas en combat"
L["OPTIONS_THREAT_AGGROSTATE_ONYOU_LOWAGGRO"] = "L'Aggro est sur vous mais est faible"
...
Couleur quand vous jouez en tant que DPS ou HEALER]=]
...
L["OPTIONS_THREAT_DPS_CANCHECKNOTANK"] = "Vérifier si il n'y à pas d'Aggro de tank"
L["OPTIONS_THREAT_DPS_CANCHECKNOTANK_DESC"] = "Lorsque vous n'avez pas l'aggro en tant que soigneur ou dps, vérifier si l'ennemi attaque une autre unité qui n'est pas un tank."
...
L["OPTIONS_THREAT_MODIFIERS_NAMECOLOR"] = "Nom Couleur"
