...
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_ANCHOR_TITLE"] = "투명도 제어"
...
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_RANGECHECK_ENABLED"] = "거리에 따른 투명도 사용"
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_RANGECHECK_ENABLED_DESC"] = [=[거리 밖의 유닛들의 이름표가 더 투명하게 보입니다.

|cFFFFFF00중요|r: 거리를 확인할 기준이 될 주문이 필요합니다.]=]
...
L["OPTIONS_PROFILE_CONFIG_PROFILENAME_DESC"] = [=[새로운 프로필을 문자열로부터 가져옵니다.

기존 프로필 이름을 입력하시면, 기존 프로필을 덮어씁니다.]=]
...
L["OPTIONS_THREAT_COLOR_OVERRIDE_DESC"] = [=[게임 내의 중립, 적대적 그리고 우호적 유닛의 색상을 설정합니다.

전투 중에는, 위협 수준 색상으로 덮어씌워집니다.]=]
