...
L["OPTIONS_GENERALSETTINGS_HEALTHBAR_ANCHOR_TITLE"] = "血条材质外观"
L["OPTIONS_GENERALSETTINGS_HEALTHBAR_BGCOLOR"] = "血条材质背景的颜色和透明度"
L["OPTIONS_GENERALSETTINGS_HEALTHBAR_BGTEXTURE"] = "血条背景材质"
L["OPTIONS_GENERALSETTINGS_HEALTHBAR_TEXTURE"] = "血条材质"
...
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_RANGECHECK_ENABLED"] = "启用范围检查"
L["OPTIONS_GENERALSETTINGS_TRANSPARENCY_RANGECHECK_ENABLED_DESC"] = [=[超出范围后姓名版的透明度 (调整下面滑块中的数量)。
|cFFFFFF00重点|r: 设定您要用于范围检查的技能。]=]
