...
function TBag:LayoutWindow(frame)
  ...
  if (framename == "TInvFrame") then
    ...
    if ((TInv_SearchBox:IsVisible()
        ...
        TInvFrame_MoneyFrame:IsVisible()) then
...
--                if (itemitm[self.I_TYPE] ~= L["Container"]) then
                ...
                if (bagtype and itmfam) then
                  if (bagtype == 1 and itmfam == 1) or
                    (bagtype == 2 and itmfam == 2) or
                    (bagtype == 3 and itmfam == 3) or
                    (bagtype == 6 and itmfam == 6) or
                    (bagtype == 7 and itmfam == 7) then
